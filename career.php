...
if(isset($_POST['submit'])){
    ...
    $subject = 'User Career Details';
    $from=$email;

    $htmlContent = "
<h1>User Sending Message</h1>
<p><b>User Name: </b>".$name."</p>
<p><b>User Type of Work: </b>".$work."</p>
<p><b>User Phone: </b>".$number."</p>
<p><b>User Email: </b>".$email."</p>
<p><b>User Work Experince: </b>".$workexp."</p>
<p><b>User Year Experince: </b>".$year."</p>
<p><b>User Have Resume: </b>".$resume."</p>
<p><b>User Desire Pay: </b>".$pay."</p>
...
<!-- Sub banner start -->
<div class="sub-banner overview-bgi" style="background-image: url(assets/img/sub-banner.jpg);">
    <div class="container">
...
<div class="contact-1 content-area-7">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-md-8" style="border: 2px solid;color: black;">
                <div>&nbsp;</div><div>&nbsp;</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12" >
                            <div class="form-group selectBox">*Type of Work
                                <select name="work" style="width: 240px;height: 45px;display: inline-block;" required>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group email">
                                <h5 style="color: black" name="resume" >*Do you have resume :</h5>
