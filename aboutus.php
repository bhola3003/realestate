...
<head>
    ...
    <title>F&U REAL ESTATE | ABOUT US</title>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-md-8">
               <p style="font-size: 15px">F&U Real Estate Investment is family owned and operated company. Founded in 2018 by the Petrovic Family. </p>
            </div>
            <div class="col-lg-2 col-md-2 col-md-2"></div>
